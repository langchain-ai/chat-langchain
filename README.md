...
This repo is an implementation of a locally hosted chatbot specifically focused on question answering over the [LangChain documentation](https://python.langchain.com/docs).
...
2. Load html with LangChain's [ReadTheDocs Loader](https://python.langchain.com/docs/modules/data_connection/document_loaders/integrations/readthedocs_documentation)
3. Split documents with LangChain's [TextSplitter](https://python.langchain.com/docs/modules/data_connection/document_transformers/#text-splitters)
...
Question-Answering has the following steps, all handled by [ChatVectorDBChain](https://python.langchain.com/docs/modules/chains/popular/chat_vector_db):
