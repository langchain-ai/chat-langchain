  ...
  return (
    ...
    >
      <ComposerPrimitive.Input
        ...
        rows={1}
        className="placeholder:text-gray-400 text-black max-h-40 flex-1 resize-none border-none bg-transparent px-2 py-1 text-sm md:text-lg outline-none focus:ring-0 disabled:cursor-not-allowed"
      />
