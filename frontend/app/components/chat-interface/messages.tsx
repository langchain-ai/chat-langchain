    ...
    <MessagePrimitive.Root className="flex w-full md:max-w-4xl md:mx-0 mx-auto max-w-[95%] md:py-4 py-2">
      <div className="bg-inherit text-black max-w-full sm:max-w-3xl break-words leading-6 sm:leading-7">
        ...
        <div>
          ...
          <a className="uppercase bg-[#767676] border border-gray-600 rounded-lg p-4 mt-4 text-center text-white" href="https://verafiles.atlassian.net/jira/software/c/form/03737abd-4aaf-4e2c-960c-570ac7f11f12" target="_blank">Report Issue</a>
        </div>
