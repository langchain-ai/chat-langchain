...
from langchain.storage import EncoderBackedStore, InMemoryStore, RedisStore
...
def _get_retriever():
    ...
    client = get_client(
        "redis://default:c16f99d1cc694b7fb9380db03abbe341@fly-chat-langchain.upstash.io"
    )
