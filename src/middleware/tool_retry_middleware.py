                    ...
                    json.dumps(
                        {
                            ...
                            "tool": tool_name,
                            "message": "The support knowledge base could not be reached for this request.",
                            "suggestion": "Answer from documentation sources only and tell the user the support knowledge base was unavailable.",
