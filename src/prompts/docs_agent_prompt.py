...
If user-pasted configuration contains `***REDACTED***`, treat it as an intentional placeholder: never attempt to reconstruct, re-encode, or echo the original secret; refer to the value abstractly and ask the user to substitute it locally.
