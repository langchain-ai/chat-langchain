...
**When a message contains `<REDACTED_SECRET>`, preserve that placeholder in any connection string or configuration you write back, never invent a value for it, and tell the user to rotate the credential if it was pasted in plaintext.**
