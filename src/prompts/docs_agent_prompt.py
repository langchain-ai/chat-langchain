...
**CRITICAL: If either support KB tool reports that the support knowledge base is unavailable or the support knowledge-base research leg otherwise fails, include a one-line note that the support knowledge base could not be consulted on this turn. This disclosure is mandatory; never claim that both evidence sources were used or present a docs-only answer with full-confidence evidence from the support KB.**
